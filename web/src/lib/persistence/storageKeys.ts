...
export const localStorageKeys = {
  ui: {
    ...
    workspaceGroups: namespacedKey('ui.workspace-groups.v1'),
    activeWorkspaceGroupId: namespacedKey('ui.workspace-group.active-id.v1'),
    workspaceWindows: namespacedKey('ui.workspace-windows.v1'),
    activeWorkspaceWindowId: namespacedKey('ui.workspace-window.active-id.v1'),
    workspaceSplitWindowId: namespacedKey('ui.workspace-window.split-id.v1'),
    workspaceSplitWindowIds: namespacedKey('ui.workspace-window.split-ids.v1'),
    workspaceSplitWidth: namespacedKey('ui.workspace-window.split-width.v1'),
    ...
    workspacePreviewSidebarQuery: namespacedKey('ui.workspace-preview.sidebar.query'),
    workspacePreviewSidebarPage: namespacedKey('ui.workspace-preview.sidebar.page'),
  ...
  chat: {
    ...
    lastSessionIdByWindow: namespacedKey('chat.last-session-id-by-window.v1'),
