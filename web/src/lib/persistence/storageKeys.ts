...
export const localStorageKeys = {
  ui: {
    ...
    workspaceGroups: namespacedKey('ui.workspace-editor-groups.v2'),
    activeWorkspaceGroupId: namespacedKey('ui.workspace-editor-group.active-id.v2'),
    workspaceGroupPaneRatios: namespacedKey('ui.workspace-editor-group.ratios.v2'),
    workspaceWindows: namespacedKey('ui.workspace-windows.v2'),
    activeWorkspaceWindowId: namespacedKey('ui.workspace-window.active-id.v2'),
