  ...
  <div class="flex-shrink-0 border-t border-sidebar-border/60 bg-sidebar/95">
    <div class="h-10 px-3 flex items-center justify-between gap-2">
      ...
      >
        ...
        <span class="typography-ui-label font-medium text-muted-foreground">Recent sessions</span>
      </button>
      <div class="flex items-center gap-2 flex-shrink-0">
        ...
        <SidebarPager
          ...
          prev-label="Previous recent sessions page"
          next-label="Next recent sessions page"
    ...
    <div v-if="open" class="px-2 pb-2">
      <div v-if="count === 0" class="px-2 py-2 text-xs text-muted-foreground">No recent sessions.</div>
