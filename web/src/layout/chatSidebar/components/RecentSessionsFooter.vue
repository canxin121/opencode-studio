  ...
  <div class="flex-shrink-0 border-t border-sidebar-border/60 bg-sidebar/95">
    <div class="h-10 px-3 flex items-center justify-between gap-2">
      ...
      >
        ...
        <span class="typography-ui-label font-medium text-muted-foreground">{{ t('chat.sidebar.footers.recent.title') }}</span>
      </button>
    ...
    <div v-if="open" class="px-2 pb-2">
      <div v-if="count === 0" class="px-2 py-2 text-xs text-muted-foreground">{{ t('chat.sidebar.footers.recent.empty') }}</div>
