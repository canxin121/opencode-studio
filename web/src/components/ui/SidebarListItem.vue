...
const rootClass = computed(() =>
  cn(
    'group flex w-full min-w-0 items-center gap-2 rounded-md py-1 pl-2 pr-1.5 text-left text-sm transition-colors outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset',
    props.active
...
<template>
  ...
  >
    ...
    <!-- Main Content -->
    <div class="flex min-w-0 flex-1 flex-col justify-center overflow-visible">
      <slot />
    </div>
