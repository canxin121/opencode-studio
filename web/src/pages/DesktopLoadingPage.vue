...
<template>
  <div class="flex min-h-screen items-center justify-center bg-background px-4">
    <div class="w-full max-w-[420px] rounded-2xl border border-border/80 bg-card/80 p-8 text-center shadow-xl shadow-black/5 backdrop-blur">
      <div class="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-primary/10 ring-1 ring-inset ring-primary/20">
      ...
      <div v-else class="mt-5 rounded-md border border-destructive/30 bg-destructive/10 p-3 text-left text-sm text-destructive">
        {{ backendError }}
      </div>
