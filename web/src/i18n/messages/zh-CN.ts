  ...
  git: {
    ...
    actionsMenu: {
      ...
      inspect: {
        ...
        stashStagedOnly: {
          label: '暂存（仅已暂存）',
          description: '仅暂存已暂存更改',
        },
        stashKeepIndex: {
          label: '暂存（保留索引）',
          description: '仅暂存未暂存更改',
        },
        stashIncludeUntracked: {
          label: '暂存（包含未跟踪）',
          description: '暂存已跟踪与未跟踪的更改',
        },
        stashDropAll: {
          label: '暂存（删除全部）',
          description: '删除所有暂存条目',
          confirmTitle: '删除所有暂存项？',
          confirmDescription: '这会永久删除所有暂存条目。',
          confirmText: '删除全部',
        },
      },
      branching: {
    ...
    toasts: {
      ...
      stashAppliedRef: '已应用暂存项 {ref}',
      stashPoppedRef: '已弹出暂存项 {ref}',
      stashDroppedRef: '已删除暂存项 {ref}',
      droppedStashes: '已删除 {count} 个暂存项',
      noStashesToDrop: '没有可删除的暂存项',
