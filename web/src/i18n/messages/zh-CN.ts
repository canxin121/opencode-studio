export default {
  ...
  header: {
    ...
    windowTabs: {
      newWindow: '新建窗口',
      createWindowTitle: '在新窗口中打开',
      openInWindowDescription: '将该视图创建并打开为一个窗口标签',
      windowActions: '窗口操作',
      closeActions: '关闭操作',
      ...
      closeSplit: '关闭分屏',
      dragToSplit: '拖到这里分屏',
      resizingSplit: '正在调整分屏大小…',
      resizingSidebar: '正在调整侧边栏大小…',
      focusInMain: '在主窗格中聚焦',
      splitNoContent: '未选择分屏内容。',
      group: '分组',
      newGroup: '新建分组',
      toggleGroup: '收起或展开分组',
      groupMenuTitle: '分组操作',
      expandGroup: '展开分组',
      collapseGroup: '收起分组',
      equalizeSplit: '均分分屏宽度',
      ungroupDrop: '拖到这里取消分组',
      splitDropAlreadyInGroup: '该会话或文件已在目标分组中。',
  ...
  workspaceDock: {
    ...
    refresh: '刷新面板',
    close: '关闭面板',
    noDirectory: '请先选择项目目录以查看信息。',
    placementRight: '将面板放到右侧',
    placementBottom: '将面板放到底部',
    openGit: '打开完整 Git 视图',
    openTerminal: '打开完整终端视图',
    git: {
      tab: 'Git',
      branch: '分支',
      noRepo: '当前目录不是仓库',
    ...
    preview: {
      ...
      addDialog: {
        title: '添加预览会话',
        description: '输入目标 URL，创建由 Studio 管理的预览会话。',
      },
      editDialog: {
        title: '编辑预览会话',
        description: '更新该预览会话的目标 URL。',
      },
      renameDialog: {
        title: '重命名预览会话',
        description: '修改该预览会话的名称。',
      },
      sidebar: {
        ...
        sections: {
          chat: {
            title: '当前聊天',
            emptyNoSession: '请先选择一个聊天会话以查看对应预览。',
            empty: '当前聊天会话还没有预览。',
          },
          directory: {
            title: '当前目录',
            emptyNoDirectory: '请先选择一个目录以查看对应预览。',
            empty: '当前目录还没有预览。',
          },
          all: {
            title: '全部预览',
        ...
        actions: {
          ...
          start: '启动',
          startDescription: '启动该会话的预览命令。',
          startFailed: '启动预览会话失败 / Failed to start preview session. 详情：{detail}',
          stop: '停止',
          stopDescription: '停止该会话的预览命令。',
          stopFailed: '停止预览会话失败 / Failed to stop preview session. 详情：{detail}',
          editUrl: '编辑目标 URL',
          editUrlDescription: '修改该会话实际代理到的目标地址。',
          editUrlUnavailable: '该会话没有可编辑的目标 URL。',
          deleteDescription: '删除该预览会话。',
          deleteFailed: '删除预览会话失败 / Failed to delete preview session. 详情：{detail}',
          deleteConfirmTitle: '删除预览会话？',
          deleteConfirmDescription: '该操作会从 Studio 中移除预览会话，且无法撤销。',
        },
      },
      sessionsTitle: '会话列表',
      directoryLabel: '目录：',
      targetLabel: '目标 URL（仅展示）：',
      proxyPathLabel: '实际访问：',
      urlEmpty: '尚未选择预览会话',
      scope: {
        current: '当前',
      ...
      emptyState: {
        ...
        sessionIdHelp: '只能包含字母数字、_、-。',
        runDirectoryLabel: '运行目录',
        ...
        addAction: '添加',
        autoDetectAction: '自动发现',
        createLoading: '正在创建预览会话...',
        discoverLoading: '正在自动发现本地预览...',
        directoryEmpty: '尚未选择当前目录',
        directoryRequired: '请先选择工作区目录 / Select a workspace directory first.',
        sessionIdRequired: '请先输入名称 / Enter a name first.',
        sessionIdInvalid: '名称不合法，只能包含字母数字、_、- / Invalid name. Use letters, numbers, _ or -.',
        runDirectoryRequired: '请填写运行目录 / Enter a run directory.',
        commandRequired: '请填写命令 / Enter a command.',
        argsRequired: '请填写参数 / Enter args.',
        logsPathRequired: '请填写日志文件路径 / Enter a log file path.',
        targetUrlRequired: '请先输入目标 URL / Enter a target URL first.',
        createFailed: '创建预览会话失败 / Failed to create preview session. 详情：{detail}',
        discoverFailed: '自动发现预览目标失败 / Failed to auto-detect preview target. 详情：{detail}',
      },
      states: {
        loading: '正在加载预览...',
        emptyTitle: '暂无预览会话',
        emptyDescription: '点击右侧的 + 按钮，添加目标 URL，以创建 Studio 管理的预览会话。',
        errorTitle: '预览不可用',
        errorDescription: '预览加载失败，请确认开发服务器可访问。',
        noSessionsForScope: '当前范围内还没有预览会话。',
        activeSessionMissing: '当前选择的预览会话已不存在 / The selected preview session is no longer available.',
        missingProxyBasePath: '当前选择的预览会话缺少代理路径 / The selected preview session has no proxy path.',
        sessionsFetchFailed: '加载预览会话失败 / Failed to load preview sessions. 详情：{detail}',
        sessionsFetchFailedNoDetail: '无更多详情 / No additional details',
        proxyHttpError:
          '预览代理返回错误（HTTP {status}）/ Preview proxy returned an error (HTTP {status}). 详情：{detail}',
        proxyHttpErrorNoDetail: '代理未返回更多信息 / No additional details from proxy',
        proxyRequestFailed: '无法访问预览代理，请检查服务状态 / Cannot reach preview proxy. Check service status.',
      },
    },
  },
  auth: {
  ...
  settings: {
    ...
    desktopRuntime: {
      ...
      fields: {
        ...
        uiPassword: '认证密码',
        opencodeHost: 'OpenCode 主机',
        opencodePort: 'OpenCode 端口',
        skipOpencodeStart: '不自动启动 OpenCode',
        opencodeLogLevel: 'OpenCode 日志级别',
      ...
      placeholders: {
        ...
        opencodePort: '留空则由 Studio 自动拉起 OpenCode',
      },
      options: {
        logLevel: {
      ...
      opencodePortHint: '填写后连接到已有 OpenCode 实例；留空则由 Studio 管理启动。',
      saveAndRestart: '保存并重启后端',
      toasts: {
        invalidPort: '端口必须是 1 到 65535 的整数',
        invalidOpencodePort: 'OpenCode 端口必须是 1 到 65535 的整数',
      ...
      updates: {
        title: '版本更新',
        description: '基于 GitHub Releases 检查后端服务和桌面安装包更新。安装包更新通过安装新版安装包完成。',
        fields: {
          autoCheck: '自动检查更新',
          autoPrompt: '自动显示更新提示',
          autoServiceInstall: '自动安装服务更新',
          autoInstallerInstall: '自动下载并启动桌面安装包更新',
        },
        sections: {
          service: '服务版本',
          installer: '安装包版本',
        ...
        actions: {
          ...
          remindLater: '稍后提醒（24 小时）',
          clearSuppression: '清除忽略/延迟',
          updateServiceNow: '立即更新服务',
          updatingService: '服务更新中...',
          installDesktopNow: '安装桌面更新',
          preparingInstaller: '正在准备安装包...',
        },
        ...
        suppression: {
          ...
          snoozed: '更新提醒已延后到 {until}。',
        },
        progress: {
          preparing: '正在准备更新...',
          indeterminate: '正在下载更新包...',
          percent: '已下载 {percent}%',
        },
        toasts: {
          checkedNoUpdate: '检查完成，当前已是最新版本。',
          checkFailed: '检查更新失败：{error}',
          bothAvailable: '发现新版本 {version}，服务和安装包均可更新。',
          serviceAvailable: '发现服务新版本：{version}',
          installerAvailable: '发现安装包新版本：{version}',
          ignoredVersion: '已忽略当前版本提醒。',
          ignoreVersionFailed: '忽略当前版本失败：{error}',
          reminderSnoozed: '更新提醒已延后 24 小时。',
          reminderSnoozeFailed: '延后更新提醒失败：{error}',
          reminderSuppressionCleared: '已清除忽略/延后设置。',
          reminderSuppressionClearFailed: '清除忽略/延后设置失败：{error}',
          serviceUpdated: '服务更新已完成，后端已重启。',
          serviceUpdateFailed: '服务更新失败：{error}',
          installerLaunching: '安装包已下载，正在启动安装程序...',
          installerUpdateFailed: '桌面安装包更新失败：{error}',
          autoServiceFailed: '自动服务更新失败：{error}',
          autoInstallerFailed: '自动桌面安装包更新失败：{error}',
          openReleaseFailed: '无法打开发布页面',
        },
      },
    },
    appearance: {
  ...
  terminal: {
    ...
    connection: {
      connectLabel: '启动终端会话',
      disconnectLabel: '停止终端会话',
      disconnectDescription: '这将关闭后端终端。你可以随时再次启动。',
    },
    dialogs: {
      newTerminal: {
        title: '新建终端',
    ...
    actions: {
      ...
      disconnectConfirmDescription: '这将关闭后端终端。你可以稍后再次启动。',
      disconnect: '停止',
      pin: '置顶终端',
      unpin: '取消置顶',
      delete: '删除终端',
    ...
    errors: {
      ...
      failedToStartSession: '启动终端会话失败',
      failedToStopSession: '停止终端会话失败',
    ...
    sidebar: {
      ...
      directoriesList: {
        ...
        activity: {
          ...
          blocked: '阻塞中',
          mixed: '运行 + 阻塞',
          runningTooltip: '该目录存在正在运行的会话',
          blockedTooltip: '该目录存在等待授权或提问回复的会话',
          mixedTooltip: '该目录同时存在运行中和阻塞中的会话',
        },
  ...
  git: {
    ...
    ui: {
      ...
      dialogs: {
        ...
        stashDiff: {
          title: '暂存差异',
          titleWithRef: '暂存差异：{ref}',
          description: '查看暂存补丁内容',
          loading: '暂存差异加载中...',
          empty: '没有 diff 输出。',
        },
    ...
    actionsMenu: {
      ...
      inspect: {
        ...
        stashStagedOnly: {
          label: '储藏（仅已暂存）',
          description: '仅储藏已暂存更改',
        },
        stashKeepIndex: {
          label: '储藏（保留索引）',
          description: '仅储藏未暂存更改',
        },
        stashIncludeUntracked: {
          label: '储藏（包含未跟踪）',
          description: '储藏已跟踪与未跟踪的更改',
        },
        stashDropAll: {
          label: '储藏（删除全部）',
          description: '删除所有储藏条目',
          confirmTitle: '删除所有储藏项？',
          confirmDescription: '这会永久删除所有储藏条目。',
          confirmText: '删除全部',
        },
      },
      branching: {
    ...
    toasts: {
      ...
      stashAppliedRef: '已应用储藏项 {ref}',
      stashPoppedRef: '已弹出储藏项 {ref}',
      stashDroppedRef: '已删除储藏项 {ref}',
      droppedStashes: '已删除 {count} 个储藏项',
      noStashesToDrop: '没有可删除的储藏项',
      ignoredPath: '已忽略 {path}',
      pushNeedsRemoteSetup: '未找到远程或上游分支。现在创建 GitHub 仓库并发布吗？',
      createGithubRepoAction: '创建并推送',
      createdGithubRepoAndPushed: '已创建 GitHub 仓库 {fullName} 并完成推送',
  ...
  files: {
    errors: {
      ...
      nameRequired: '名称不能为空',
      moveTargetOutsideWorkspace: '移动目标必须在工作区内',
      moveTargetInsideSelection: '不能将文件夹移动到其自身内部',
    },
    actions: {
      download: '下载',
      copyPath: '复制路径',
    ...
    toasts: {
      ...
      uploadPartial: '已上传 {success} 个文件，失败 {failed} 个',
      uploadFailed: '上传失败，共 {count} 个文件',
      movedCount: '已移动 {count} 项',
      movedPartial: '已移动 {success} 项，失败 {failed} 项',
      moveFailedCount: '移动失败，共 {count} 项',
      savedFile: '文件已保存',
      fileCreated: '文件已创建',
      ...
      deleted: '已删除',
      deleteFailed: '删除失败',
      batchDeletedSingle: '已删除 1 项',
      batchDeletedMultiple: '已删除 {count} 项',
      batchDeletedPartial: '已删除 {success} 项，失败 {failed} 项',
      batchDeleteFailed: '删除失败，共 {count} 项',
    ...
    explorer: {
      ...
      selection: {
        ...
        bulkMove: '移动已选',
        bulkMoveTitle: '移动已选项',
        bulkMoveDescription: '将已选的 {count} 项移动到以下目录：',
        bulkMovePlaceholder: '目标目录路径（相对或绝对）',
        bulkDelete: '删除已选',
        bulkDeleteTitle: '删除已选项？',
        bulkDeleteDescription: '确认删除已选的 {count} 项？此操作无法撤销。',
      },
