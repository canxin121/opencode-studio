export default {
  ...
  workspaceDock: {
    ...
    preview: {
      tab: 'Preview',
      inputPlaceholder: 'localhost:5173',
      inputAria: 'Preview URL',
      refresh: 'Refresh preview',
      openInWindow: 'Open in new window',
      targetLabel: 'Target:',
      proxyPathLabel: 'Via proxy:',
      urlEmpty: 'No preview URL yet',
      viewportDesktop: 'Desktop',
      viewportMobile: 'Mobile',
      iframeTitle: 'Workspace live preview',
      states: {
        loading: 'Loading preview...',
        emptyTitle: 'Start your app to preview',
        emptyDescription: 'Enter a URL manually, or expose a backend preview endpoint to auto-detect targets.',
