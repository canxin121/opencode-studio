export default {
  ...
  header: {
    ...
    windowTabs: {
      ...
      createWindowTitle: 'Open in new window',
      openInWindowDescription: 'Create and open this view in a window tab',
      ...
      dragToSplit: 'Drag here to split',
      resizingSplit: 'Resizing panes…',
      resizingSidebar: 'Resizing sidebar…',
      focusInMain: 'Focus in main pane',
      splitNoContent: 'No split content selected.',
      group: 'Group',
      newGroup: 'New group',
      toggleGroup: 'Collapse or expand group',
      groupMenuTitle: 'Group actions',
      expandGroup: 'Expand group',
      collapseGroup: 'Collapse group',
      equalizeSplit: 'Equalize split widths',
      ungroupDrop: 'Drop here to ungroup',
      splitDropAlreadyInGroup: 'This session or file is already in the target group.',
      ...
      closeLeft: 'Close windows to the left',
      closeRight: 'Close windows to the right',
  ...
  workspaceDock: {
    ...
    close: 'Close panel',
    noDirectory: 'Select a project directory to inspect data.',
    placementRight: 'Place panel on the right',
    placementBottom: 'Place panel on the bottom',
    openGit: 'Open full Git view',
    openTerminal: 'Open full Terminal view',
    git: {
      tab: 'Git',
      branch: 'Branch',
    ...
    preview: {
      ...
      renameDialog: {
        title: 'Rename preview session',
        description: 'Update the name for this preview session.',
      },
      sidebar: {
        ...
        actions: {
          ...
          start: 'Start',
          startDescription: 'Start the preview command for this session.',
          startFailed: 'Failed to start preview session / 启动预览会话失败。Detail: {detail}',
          stop: 'Stop',
          stopDescription: 'Stop the preview command for this session.',
          stopFailed: 'Failed to stop preview session / 停止预览会话失败。Detail: {detail}',
          ...
          deleteFailed: 'Failed to delete preview session / 删除预览会话失败。Detail: {detail}',
      ...
      proxyPathLabel: 'Via proxy:',
      urlEmpty: 'No preview session selected',
      scope: {
        current: 'Current',
        all: 'All',
      },
      ...
      emptyState: {
        ...
        runDirectoryLabel: 'Run directory',
        runDirectoryPlaceholder: '/path/to/project',
        commandLabel: 'Command',
        commandPlaceholder: 'bun',
        argsLabel: 'Args',
        ...
        addAction: 'Add',
        autoDetectAction: 'Auto-detect',
        createLoading: 'Creating preview session...',
        ...
        runDirectoryRequired: 'Enter a run directory / 请填写运行目录。',
        commandRequired: 'Enter a command / 请填写命令。',
        argsRequired: 'Enter args / 请填写参数。',
        logsPathRequired: 'Enter a log file path / 请填写日志文件路径。',
      ...
      states: {
        ...
        activeSessionMissing: 'The selected preview session is no longer available / 当前选择的预览会话已不存在。',
        missingProxyBasePath: 'The selected preview session has no proxy path / 当前选择的预览会话缺少代理路径。',
        sessionsFetchFailed: 'Failed to load preview sessions / 加载预览会话失败。Detail: {detail}',
        sessionsFetchFailedNoDetail: 'No additional details / 无更多详情',
        proxyHttpError:
          'Preview proxy returned an error (HTTP {status}) / 预览代理返回错误（HTTP {status}）。Detail: {detail}',
        proxyHttpErrorNoDetail: 'No additional details from proxy / 代理未返回更多信息',
        proxyRequestFailed: 'Cannot reach preview proxy / 无法访问预览代理，请检查服务状态。',
      },
    },
  },
  auth: {
  ...
  settings: {
    ...
    desktopRuntime: {
      ...
      updates: {
        ...
        description:
          'Check backend service and desktop installer updates from GitHub Releases. Installer updates are applied by installing the new package.',
        fields: {
          autoCheck: 'Automatically check for updates',
          autoPrompt: 'Show update prompts automatically',
          autoServiceInstall: 'Automatically install service updates',
          autoInstallerInstall: 'Automatically download and launch desktop installer updates',
        },
        sections: {
        ...
        actions: {
          ...
          remindLater: 'Remind later (24h)',
          clearSuppression: 'Clear ignore/snooze',
          updateServiceNow: 'Update service now',
          updatingService: 'Updating service...',
          installDesktopNow: 'Install desktop update',
        ...
        suppression: {
          ...
          snoozed: 'Update reminders are snoozed until {until}.',
        },
        progress: {
          preparing: 'Preparing update...',
          indeterminate: 'Downloading package...',
          percent: '{percent}% downloaded',
        },
        toasts: {
          checkedNoUpdate: 'Update check completed. You are on the latest version.',
          checkFailed: 'Update check failed: {error}',
          bothAvailable: 'New release {version} is available for service and installer.',
          serviceAvailable: 'New service version {version} is available.',
          installerAvailable: 'New installer version {version} is available.',
          ignoredVersion: 'Current release is now ignored for reminders.',
          ignoreVersionFailed: 'Failed to ignore this release: {error}',
          reminderSnoozed: 'Update reminders snoozed for 24 hours.',
          reminderSnoozeFailed: 'Failed to snooze update reminders: {error}',
          reminderSuppressionCleared: 'Update ignore/snooze settings cleared.',
          reminderSuppressionClearFailed: 'Failed to clear ignore/snooze settings: {error}',
          serviceUpdated: 'Service update applied and backend restarted.',
          serviceUpdateFailed: 'Service update failed: {error}',
          installerLaunching: 'Installer package downloaded. Launching installer...',
          installerUpdateFailed: 'Desktop installer update failed: {error}',
          autoServiceFailed: 'Automatic service update failed: {error}',
          autoInstallerFailed: 'Automatic desktop installer update failed: {error}',
          openReleaseFailed: 'Unable to open release page',
        },
      },
    },
    appearance: {
    ...
    sidebar: {
      ...
      directoriesList: {
        ...
        activity: {
          running: 'Running',
          blocked: 'Blocked',
          mixed: 'Running + blocked',
          runningTooltip: 'This directory has running sessions',
          blockedTooltip: 'This directory has sessions waiting for input or permission',
          mixedTooltip: 'This directory has running and blocked sessions',
        },
  ...
  git: {
    ...
    toasts: {
      ...
      stashAppliedRef: 'Applied stash {ref}',
      stashPoppedRef: 'Popped stash {ref}',
      stashDroppedRef: 'Dropped stash {ref}',
  ...
  files: {
    errors: {
      ...
      moveTargetOutsideWorkspace: 'Move target must stay inside the workspace',
      moveTargetInsideSelection: 'Cannot move a folder into itself',
    },
    actions: {
      download: 'Download',
      copyPath: 'Copy path',
    ...
    toasts: {
      ...
      movedPartial: 'Moved {success} items, failed {failed}',
      moveFailedCount: 'Failed to move {count} items',
    ...
    explorer: {
      ...
      selection: {
        ...
        bulkMoveTitle: 'Move selected items',
        bulkMoveDescription: 'Move {count} selected items to folder path:',
        bulkMovePlaceholder: 'Target folder path (relative or absolute)',
